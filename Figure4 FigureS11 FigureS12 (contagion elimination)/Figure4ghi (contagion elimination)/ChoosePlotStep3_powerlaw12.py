...
if __name__ == '__main__':
    ...
    Ds = 5.5; Data_path5 = './Step3 Cupy Powerlaw12 Data DecreaseBeta DecreaseDs/'
    Ds = 16.0; Data_path6 = './Step3 Cupy Powerlaw12 Data DecreaseBeta KeepDs/'
    ...
    for Data_path in Data_path_list:
        ...
        im1 = ax.imshow(uncontroledI0.reshape(L, L), cmap=custom_cmap, extent=[0, L, 0, L],
                        clim=(0, 45));  # clim=(0,11)
