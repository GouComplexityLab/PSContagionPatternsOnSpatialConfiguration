...
if __name__ == '__main__':
    ...
    Q_n = 4
    controledOmege = 8.513
    Ds = 2.5; Data_path1 = './Step2 Cupy Delta12 Data IsolateI DecreaseDs/'
    Ds = 16.0; Data_path2 = './Step2 Cupy Delta12 Data IsolateI KeepDs/'
    ...
    for Data_path in Data_path_list:
        ...
        ax.set_axis_off()
        plt.savefig(NewFigurePath + 'initial uncontroledI Urban Infectious ' + ' with colorbar.png', bbox_inches='tight',
                    pad_inches=0)
        plt.savefig(NewFigurePath + 'initial uncontroledI Urban Infectious ' + ' with colorbar.eps', bbox_inches='tight',
                    pad_inches=0)
        plt.close()
        # plt.show()
        ...
        fig, ax = plt.subplots(figsize=(6, 6))
        im1 = ax.imshow(controledI0.reshape(L, L), cmap=custom_cmap, extent=[0, L, 0, L], clim=(min_I0, max_I0));
        ax.set_axis_off()
