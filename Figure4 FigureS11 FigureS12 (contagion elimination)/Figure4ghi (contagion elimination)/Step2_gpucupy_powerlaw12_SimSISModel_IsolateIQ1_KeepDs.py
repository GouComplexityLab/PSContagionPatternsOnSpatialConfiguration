...
if __name__ == '__main__':
    ...
    ControlData_path = './Step1 Cupy Powerlaw12 Data N={} Omega={} beta={} nu={}/'.format(node_number, Omega, beta, nu)
    ...
    # control_component_n = nnn_pre_control_components
    # control_components = np.arange(control_component_n)
    # pre_control_components_n = np.asarray([6, 7, 8, 10, 0, 3, 2, 5, 12, 9, 1, 4, 11], dtype=np.int_)
    ...
    Data_path = './Step2 Cupy Powerlaw12 Data IsolateI KeepDs/'
    print(Data_path)
    ...
    FigurePath = './Step2 Cupy Powerlaw12 Figure IsolateI KeepDs/'
