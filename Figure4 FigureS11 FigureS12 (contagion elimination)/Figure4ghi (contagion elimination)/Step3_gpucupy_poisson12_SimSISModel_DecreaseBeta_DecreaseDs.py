...
if __name__ == '__main__':
    ...
    ControlData_path = './Step1 Cupy Poisson12 Data N={} Omega={} beta={} nu={}/'.format(node_number, Omega, obeta, nu)
    ...
    Data_path = './Step3 Cupy Poisson12 Data DecreaseBeta DecreaseDs/'
    print(Data_path)
    ...
    FigurePath = './Step3 Cupy Poisson12 Figure DecreaseBeta DecreaseDs/'
