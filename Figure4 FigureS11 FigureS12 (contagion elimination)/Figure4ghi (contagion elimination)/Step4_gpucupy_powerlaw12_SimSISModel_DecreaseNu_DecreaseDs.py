...
if __name__ == '__main__':
    ...
    ControlData_path = './Step1 Cupy Powerlaw12 Data N={} Omega={} beta={} nu={}/'.format(node_number, Omega, beta, onu)
    ...
    Data_path = './Step4 Cupy Powerlaw12 Data DecreaseNu DecreaseDs/'
    print(Data_path)
    ...
    FigurePath = './Step4 Cupy Powerlaw12 Figure DecreaseNu DecreaseDs/'
