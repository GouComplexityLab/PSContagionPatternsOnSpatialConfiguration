...
if __name__ == '__main__':
    ...
    ControlData_path = './Step1 Cupy Delta12 Data N={} Omega={} beta={} nu={}/'.format(node_number, Omega, obeta, nu)
    ...
    Data_path = './Step3 Cupy Delta12 Data DecreaseBeta DecreaseDs/'
    print(Data_path)
    ...
    FigurePath = './Step3 Cupy Delta12 Figure DecreaseBeta DecreaseDs/'
    ...
    ax[0].imshow(uncontroledS0.reshape(L, L), cmap=custom_cmap, extent=[0, L, 0, L]);
    ax[0].set_title('$S$ density')

    ax[0].set_axis_off()

    ax[1].imshow(uncontroledI0.reshape(L, L), cmap=custom_cmap, extent=[0, L, 0, L]);
    ...
    fig, ax = plt.subplots(1, 2, figsize=(16, 6))
    ax[0].imshow(controledS0.reshape(L, L), cmap=custom_cmap, extent=[0, L, 0, L]);
    ax[0].set_title('$I$ density uncontroled')

    ax[0].set_axis_off()

    ax[1].imshow(controledI0.reshape(L, L), cmap=custom_cmap, extent=[0, L, 0, L]);
    ...
    fig, ax = plt.subplots(1, 2, figsize=(16, 6))
    ax[0].imshow(uncontroledI0.reshape(L, L), cmap=custom_cmap, extent=[0, L, 0, L]);
