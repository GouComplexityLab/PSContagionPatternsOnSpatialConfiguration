...
if __name__ == '__main__':
    ...
    ControlData_path = './Step1 Cupy Delta12 Data N={} Omega={} beta={} nu={}/'.format(node_number, Omega, beta, nu)
    ...
    Data_path = './Step2 Cupy Delta12 Data IsolateI DecreaseDs/'
    print(Data_path)
    ...
    FigurePath = './Step2 Cupy Delta12 Figure IsolateI DecreaseDs/'
