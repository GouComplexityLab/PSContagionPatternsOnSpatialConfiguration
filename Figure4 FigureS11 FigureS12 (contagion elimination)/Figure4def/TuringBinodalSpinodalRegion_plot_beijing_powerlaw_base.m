...
f2 = fill(x_fill, y_fill, 'r', 'FaceAlpha', 0.2,'EdgeColor', 'b','LineWidth',gwLineWidth,'LineStyle','-');  % 'c'表示填充颜色为青色，'FaceAlpha'控制填充的透明度\
...
% arrow 2==>2 out
startX = point2(1); startY = point2(2); 
endX = point2_out(1);   endY = point2_out(2); 
...
s1 = 220-20;
scatter(point2(1), point2(2), s1,'MarkerFaceColor','k', ...
    'MarkerEdgeColor','k','Marker','.');
s1 = 80-20*2;
scatter(point2_out(1), point2_out(2), s1,'MarkerFaceColor','k', ...
...
figure_name = ['./Beijing base ' pre_figname '.eps'];
