function plot_parabola_through_points_color(point1,point2,h,colorname,lw,lc)
...
scatter3(x_line_xy,y_line_xy,zz_line_xy,5*(t+t(2)), t+t(2), 'filled',...
    'MarkerEdgeColor','none',...
    'MarkerFaceColor',colorname);
