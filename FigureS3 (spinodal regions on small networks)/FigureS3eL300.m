...
%%
netname = 'NetDelta12L300';
% netname = 'NetPoisson12L300';
% netname = 'NetPowerlaw12L300';
data_name = [netname 'RegionDataSmall_beta=' dot2d(beta) '_nu=' dot2d(nu) '.mat'];
eval(['load ' data_name])

load Delta12eigenvalues_with_L=300 first_smallest_eigenvalues
...
load poisson12eigenvalues_with_L=300 first_smallest_eigenvalues
Lambda2_poisson12 = first_smallest_eigenvalues(2);

load powerlaw12eigenvalues_with_L=300 first_smallest_eigenvalues
