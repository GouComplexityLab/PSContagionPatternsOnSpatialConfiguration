    ...
    for ICn in np.asarray([1]):
        for p in p_values:
            ...
            for iter in range(total_iteration):
                if (iter + 1) % step == 0:
                    # for iter in np.asarray([400*step - 1]):
                    #     if True:
            ...
            #                                                'array_series_S0_at_nodes_seedingI': array_series_S0_at_nodes_seedingI,
            #                                                'array_series_I0_at_nodes_seedingI': array_series_I0_at_nodes_seedingI,
