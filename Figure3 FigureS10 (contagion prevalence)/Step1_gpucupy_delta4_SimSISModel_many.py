...
if __name__ == '__main__':
    ...
    ####################################################################################################################
    Network_path = './Generated delta Lattice Embedded Networks L=500 dg=4'
    if not os.path.exists(Network_path):
        raise ('There is not the path of data')
    laplacian_name_npz = '/laplacian_matrix_deltaLEN_L=500_dg=4_number=1.npz'
    ...
    for Omega in np.asarray([13.36, 22, 26]):
        ...
        ICData_path = './The same initial conditions for spatial configurations/'
        ...
        Data_path = './Step1 Cupy Delta4 Data N={} Omega={} beta={} nu={}/'.format(node_number, Omega, beta, nu)
        ...
        for iter in range(total_iteration):
            ...
            if (iter + 1) % step == 0:
                ...
                print('Omega',Omega,'current iteration', iter + 1, '/', total_iteration, 'sim_time', "{:.4f}".format(sim_time))
