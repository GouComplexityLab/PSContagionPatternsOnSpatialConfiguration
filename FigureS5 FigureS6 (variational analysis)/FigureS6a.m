...
p_star = 29.3; % p_low<p_star<p_star_maxwell<p_up
% p_star = 12.0; % <p_low
% p_star = 122.0; % >p_up
...
annotation('textbox',...
    [0.674608680150392 0.442599206349207 0.070946875405164 0.11],...
    'String','$Q_{0}$',...
    'Interpreter','latex',...
    'FontSize',36,...
    'FitBoxToText', 'off', ...
...
annotation('textbox',...
    [0.387222222222222 0.433869047619048 0.0755555555555553 0.11],...
    'String','$Q_{-}$',...
    'Interpreter','latex',...
    'FontSize',36,...
    'FitBoxToText', 'off', ...
...
annotation('textbox',...
    [0.182222222222222 0.440714285714287 0.0761111111111113 0.11],...
    'String','$Q_{+}$',...
    'Interpreter','latex',...
    'FontSize',36,...
    'FitBoxToText', 'off', ...
